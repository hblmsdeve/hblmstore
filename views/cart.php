    ...
    <div class="row">
        <div class="col-md-8 bg-white">
                    ...
                    <tr>
                        ...
                        <td>
                            <form method="POST" action="<?php echo BASE_URL;?>cancelCart">
                                ...
                                <button type="submit" class="btn btn-sm btn-danger text-white font-weight-bold p-1">&times;</button>
                            </form>
                        </td>
                    </tr>
                    <?php endif; ?>
            ...
            <?php elseif(isset($_SESSION["count"]) && $_SESSION["count"] > 0) : ?>
                <a href="<?php echo BASE_URL; ?>login" class="btn btn-link">Connectez vous pour teminer vos achats</a>
            <?php endif; ?>
        </div>
            ...
            <table class="table table-bordered">
                <tbody>
                    <tr>
                        ...
                        <td><?php echo isset($_SESSION["count"]) ? $_SESSION["count"] : 0; ?></td>
                    </tr>
                    <tr>
